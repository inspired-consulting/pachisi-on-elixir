defmodule PachisiOnElixirWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PachisiOnElixirWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PachisiOnElixirWeb.Gettext, "errors", msg, opts)
    end
  end
